package tech.tryu.prototype;

import tech.tryu.prototype.demo1.TestEntity;
import tech.tryu.prototype.demo1.Circle;
...
public class PrototypeApplication extends Object{
    ...
    public static void main(String[] args) {
        TestEntity testEntity = new TestEntity(0, "testEntity");
        Circle circle = new Circle(1.00, 2.00, "red", new BigDecimal("1.03"), testEntity);
        Circle cloneInterface = circle.clone();
        assert circle != cloneInterface;
        System.out.println(circle.getTestEntity());
        System.out.println(cloneInterface.getTestEntity());
