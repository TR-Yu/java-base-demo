...
public class Facebook implements SocialNetwork {
    ...
    @Override
    public ProfileIterator createFriendIterator( Long profiledId) {
        return new FacebookIterator(this, profiledId, "friends");
    }

    @Override
    public ProfileIterator createCoworkersIterator( Long profiledId) {
        return new FacebookIterator(this, profiledId, "coworkers");
    }

    public Profile[] socialGraphRequest( Long profileId, String type) {
