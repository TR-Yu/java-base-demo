...
import tech.tryu.thread.threadwaitnotify.blockqueue.Queue;
import tech.tryu.thread.threadwaitnotify.blockqueue.QueueOperator;
...
public class WaitNotifyDemo {
    ...
    public static void main(String[] args) {
        ...
        ThreadPoolExecutor threadPoolExecutor =
                new ThreadPoolExecutor(cpuCore, cpuCore * 2, 1, TimeUnit.SECONDS,
